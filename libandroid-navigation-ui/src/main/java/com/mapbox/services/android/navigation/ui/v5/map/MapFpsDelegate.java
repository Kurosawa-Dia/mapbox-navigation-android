...
class MapFpsDelegate {
  ...
  private final FpsDelegateTrackingChangedListener fpsTrackingListener = new FpsDelegateTrackingChangedListener(this);
  ...
  void addTrackingChangedListener(NavigationCamera camera) {
    this.camera = camera;
    camera.addTrackingModeTransitionListener(fpsTrackingListener);
  }
  ...
  void onStop() {
    ...
    if (camera != null) {
      camera.removeTrackingModeTransitionListener(fpsTrackingListener);
    }
  }
